...
\todo{write here about normal growth scaling plan}
...
\todo{spike scaling plan description}
...
\resizebox{\textwidth}{!}{
	    ...
	    Ubuntu Linux & 12.04.1 LTS & Operating System on all nodes. Baseline Amazon machine image \texttt{ami-3d4ff254}. \\ \hline
	    \end{tabular}
}
