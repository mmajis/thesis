...
execute them. This is known as a MAPE-K control loop \todo{cite MAPE-K} named
...
exist for more complicated usage patterns \todo{cite predictive scaling
algorithms}. Predictive scaling is possible as long as there is some indicator
...
Further related to price, \textit{billing granularity} affects QoE \todo{cite
billing granularity}. The minimum price paid for a provisioned VM instance as
...
Tradeoff Analysis Method \todo{cite ATAM} can be used to elicit the preferences
...
\todo{Mention netflix chaos monkey wrt design for failure}
